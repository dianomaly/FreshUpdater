...
public class HiberUtils {
	...
	public static SessionFactory getSession() {
		...
		try {
			 ...
			 * 
			 * newmeta = new
			 * MetadataSources(newregistry).buildMetadata().buildSessionFactory();
			 * 
			...
			props.put("hibernate.connection.url", "jdbc:mysql://localhost:3306/fullbringdata");
	...
	/*
	 * private static SessionFactory buildSessionJavaConfigFactory() { try {
	 * Configuration newconf = new Configuration(); // Create Properties, can be
	 * read from property files too Properties props = new Properties();
	 * props.put("hibernate.connection.driver_class", "com.mysql.jdbc.Driver");
	 * props.put("hibernate.connection.url",
	 * "jdbc:mysql://localhost:3306/excel_schema");
	 * props.put("hibernate.connection.username", "fullbringUS");
	 * props.put("hibernate.connection.password", "Customer1");
	 * props.put("hibernate.dialect", "org.hibernate.dialect.MySQLDialect");
	 * props.put("hibernate.c3p0.acquire_increment", "1");
	 ...
	 * props.put("hibernate.c3p0.max_statements", "10");
	 * props.put("hibernate.c3p0.min_size", "10");
	 * props.put("hibernate.c3p0.timeout", "100"); newconf.setProperties(props);
	 * //newconf.addAnnotatedClass(FullLineBlock.class);
	 * newconf.addAnnotatedClass(sqlrepmod.class); newregistry = new
	 * StandardServiceRegistryBuilder().applySettings(newconf.getProperties()).build
	 * (); System.out.println("Hibernate Java Config serviceRegistry created");
	 * SessionFactory sessionFactory = newconf.buildSessionFactory(newregistry);
